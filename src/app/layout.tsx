...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "SmartPetLab",
    images: [
      {
        url: "https://smartpetlab.vercel.app/hero-dog.png",
        width: 1200,
        height: 630,
        alt: "SmartPetLab",
      },
  ...
  twitter: {
    ...
    title: "SmartPetLab | High-Tech Pet Care Reviews",
    description: "Expert reviews and guides on the latest smart pet technology.",
    creator: "@smartpetlab",
    images: ["https://smartpetlab.vercel.app/og-image.jpg"],
  },
};
